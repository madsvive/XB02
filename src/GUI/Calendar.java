    ...
    public Calendar() {
        ...
        try {
	        ...
	        while (rs.next()) {
	        	...
	        	data[count][0] = rs.getString("Active");
	        	data[count][1] = rs.getString("CalendarID");
	        	data[count][2] = rs.getString("CreatedBy");
	        	data[count][3] = rs.getString("Name");
	        	data[count][4] = rs.getString("PrivatePublic");
        ...
        scrollPane.setBounds(150, 225, 848, 361);
        ...
        lblCalendar.setBounds(397, 118, 547, 84);
        ...
        lblNewLabel.setIcon(new ImageIcon(Calendar.class.getResource("/Images/CBSLogo3.png")));
        add(lblNewLabel);
    
        JLabel lblBackground = new JLabel("Background");
        lblBackground.setBounds(-21, 0, 1376, 768);

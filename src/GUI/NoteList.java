...
//				data[count][4] = rs.getString("createdBy"); Er lavet i databasen men skal ogs� tilpasses i GUI
//				data[count][5] = rs.getString("active"); Er lavet i databasen men skal ogs� tilpasses i GUI
